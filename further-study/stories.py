...
story2 = Story(
    ...
    "A SciFi Adventure",
    ["place", "noun", "verb", "adjective", "plural_noun"],
    """Along time ago in a far away {place}, suddenly a
       large {adjective} {noun} was discovered. It was found 
       to {verb} {plural_noun}."""
)
...
story3 = Story(
    ...
    "A Western Story",
    ["place", "noun", "verb", "adjective", "plural_noun"],
    """Across the vast plains of {place}, suddenly a
       large {adjective} {noun} was discovered. It was found 
       to contain {verb} {plural_noun}."""
)
